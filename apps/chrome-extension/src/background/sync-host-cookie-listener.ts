...
/**
 * When the user signs in on the vmem web app, Clerk updates session cookies on
 * syncHost. Re-warm background auth so auto-sync works without opening the popup.
 */
