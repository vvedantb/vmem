...
export default function GraphNavControls({
  ...
  const btnClass = isDarkCanvas
    ...
    : "w-8 h-8 flex items-center justify-center rounded-md bg-surface-secondary/40 hover:bg-surface-secondary/60 text-muted hover:text-foreground transition-colors";
