...
export default function Sidebar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 h-16 bg-sidebar z-50 md:hidden flex items-center justify-between px-6">
        <Link
          href="/"
      ...
      <aside
        className={`
          fixed top-16 md:top-0 left-0 h-[calc(100vh-4rem)] md:h-screen bg-sidebar z-40
