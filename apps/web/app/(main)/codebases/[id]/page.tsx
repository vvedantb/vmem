...
import { CodebaseGraph } from "./_components/CodebaseGraph";
...
export default function CodebaseDetailPage({
  ...
  const { id } = use(params);
  // getById accepts v.string() — no Id cast needed from URL params
    ...
    return (
      <PageContainer title="Codebase Not Found">
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-foreground font-medium mb-2">Codebase not found</p>
