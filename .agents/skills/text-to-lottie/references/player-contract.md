  ...
  "controls": [
    {
      "sid": "brandName",
      "label": "Brand Name",
      "targetSids": ["heroBrandName", "lowerThirdBrandName", "endCardBrandName"]
    },
    {
      "sid": "eventDate",
      "label": "Event Date",
      "targetSids": ["heroDate", "agendaDate", "endCardDate"]
    }
  ]
}
```
...
- **Top-aligned, no vertical-centering.** Text starts at the box top and grows
  ...
  _top-left_. To visually center a known block, offset `ps.y` by hand (≈
  `(sz[1] - blockHeight) / 2`).
