...
- Always read the AGENTS.md file (if it exists) first to understand the codebase's specific rules
...
- If you have learnt anything new from the user, ie their preference of implementing something, then include this in the AGENTS.md too in a short concise format
- Never use `any`
- Never use `unknown`
...
- Ensure AGENTS.md is updated if architecture decisions changed and with new learnings.

Implementation Process:

- Read AGENTS.md first (if exists)
