  ...
  return (
    <div
      className={cn(
        ...
        "group-data-[role=assistant]:bg-muted/50 group-data-[role=assistant]:border group-data-[role=assistant]:border-border group-data-[role=assistant]:text-foreground group-data-[role=assistant]:rounded-bl-md",
        className,
      )}
      {...props}
    />
